...
## Description
A top-down shooter where you fight your way through hoards of zombies/enemies with your trusty guns, getting money along the way to purchase upgrades to assist you in taking down the increasingly difficult waves.


It would somewhat be a recreation of a game I made on Scratch called "Blob Slayer", which has a similar gameplay loop minus the shop.
...
- Enemies
    ...
    - Multiple different enemy types
        - Basic enemies with simple stat redistributions
